...
import { inputClass, labelClass, goldButtonClass } from "~/lib/constants";
...
export function ProfileForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {username.length >= 3 && usernameAvailable !== null && (
            <p
              className={`mt-1 text-xs ${usernameAvailable ? "text-emerald-400" : "text-red-400"}`}
            >
      ...
      {/* Media Section */}
      <div className="space-y-4 border-t border-[var(--divider)] pt-6">
        <h2 className="text-sm font-semibold text-muted uppercase tracking-wide">Media</h2>
        <div>
      ...
      {/* Details Section */}
      <div className="space-y-4 border-t border-[var(--divider)] pt-6">
        <h2 className="text-sm font-semibold text-muted uppercase tracking-wide">Details</h2>
        <div>
      ...
      <div className="space-y-4 border-t border-[var(--divider)] pt-6">
        <h2 className="text-sm font-semibold text-muted uppercase tracking-wide">Social Links</h2>
      ...
      <button
        ...
        className={`w-full ${goldButtonClass}`}
      >
      ...
      {updateProfile.isSuccess && (
        <p className="text-sm text-[#D4AF37]">Profile saved.</p>
      )}
    </form>
  );
}
